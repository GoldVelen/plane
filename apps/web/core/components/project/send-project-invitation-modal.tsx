    ...
    await bulkAddMembersToProject(workspaceSlug.toString(), projectId.toString(), payload)
      .then(() => {
        ...
        setToast({
          ...
          message: t("project_settings.members.invite_members.success"),
        });
      })
      .catch((error) => {
        console.error(error);
              ...
              <div key={field.id} className="group mb-1 flex w-full items-start justify-between gap-x-4 text-13">
                <div className="flex w-full grow flex-col gap-1">
                  <Controller
                    ...
                    rules={{ required: t("project_settings.members.invite_members.member_required") }}
                ...
                <div className="flex shrink-0 items-center justify-between gap-2">
                  <div className="flex flex-col gap-1">
                    <Controller
                      ...
                      control={control}
                      rules={{ required: t("project_settings.members.invite_members.role_required") }}
                      render={({ field }) => (
                        <CustomSelect
                          {...field}
                          customButton={

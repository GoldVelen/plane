...
export const useWorkItemCommentOperations = (
  ...
  const operations: TCommentsOperations = useMemo(() => {
      ...
      addCommentReaction: async (commentId, reaction) => {
        try {
          ...
          setToast({
            ...
            type: TOAST_TYPE.SUCCESS,
            message: t("legacy_ui.reaction_created_successfully"),
          });
        } catch {
          setToast({
            title: t("toast.error"),
            type: TOAST_TYPE.ERROR,
            message: t("legacy_ui.reaction_creation_failed"),
          });
        }
      },
      deleteCommentReaction: async (commentId, reaction) => {
        try {
          ...
          setToast({
            title: t("toast.success"),
            type: TOAST_TYPE.SUCCESS,
            message: t("legacy_ui.reaction_removed_successfully"),
          });
        } catch {
          setToast({
            title: t("toast.error"),
            type: TOAST_TYPE.ERROR,
            message: t("legacy_ui.reaction_remove_failed"),
          });
        }
      },
    ...
    return ops;
  }, [workspaceSlug, projectId, issueId, createComment, updateComment, uploadEditorAsset, removeComment, t]);

      ...
      <div>
        ...
        <div className="mt-6">
          ...
          {currentActiveEstimateId ? (
            <>
              ...
              <div className="mt-12 flex flex-col gap-y-4">
                <SettingsHeading title={t("legacy_ui.estimates_list")} variant="h6" />
                <EstimateList
          ...
          {archivedEstimateIds && archivedEstimateIds.length > 0 && (
            <div className="mt-12 flex flex-col gap-y-4">
              <SettingsHeading
                title={t("legacy_ui.archived_estimates")}
                description={
                  <>
                    {t("legacy_ui.estimates_have_gone_through_a_change_these_are_the_estimates_you_had_in_your_old")}
                    <a

            ...
            <PieChart
              ...
              data={
                userProfile.state_distribution.map((group) => ({
                  ...
                  name: t(STATE_GROUPS[group.state_group].labelTranslationKey),
              ...
              showTooltip
              tooltipLabel={t("common.work_items")}
              paddingAngle={5}
              cornerRadius={4}
              innerRadius="50%"
              showLabel={false}
                ...
                {stateDistribution.map((group) => (
                  <div key={group.state_group} className="flex items-center justify-between gap-2 text-11">
                    <div className="flex items-center gap-1.5">
                      ...
                      />
                      <div className="whitespace-nowrap">{t(STATE_GROUPS[group.state_group].labelTranslationKey)}</div>
                    </div>

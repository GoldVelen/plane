...
import { EOnboardingSteps, EProjectAccessScope } from "@plane/types";
  ...
  return (
    ...
    >
      <CommonOnboardingHeader
        title={t("legacy_ui.invite_your_teammates")}
        description={t("legacy_ui.work_in_plane_happens_best_with_your_team_invite_them_now_to_use_plane_to_its_po")}
      />

...
const ROLES = [
  { id: "product-manager", i18nKey: "onboarding.role.roles.product_manager", icon: Box },
  { id: "engineering-manager", i18nKey: "onboarding.role.roles.engineering_manager", icon: ViewsIcon },
  { id: "designer", i18nKey: "onboarding.role.roles.designer", icon: PenTool },
  { id: "developer", i18nKey: "onboarding.role.roles.developer", icon: Monitor },
  { id: "founder-executive", i18nKey: "onboarding.role.roles.founder_executive", icon: Rocket },
  { id: "operations-manager", i18nKey: "onboarding.role.roles.operations_manager", icon: RefreshCw },
  { id: "others", i18nKey: "onboarding.role.roles.others", icon: Box },
];
  ...
  const handleSubmitUserPersonalization = async (formData: TProfileSetupFormValues) => {
    ...
    try {
      ...
      setToast({
        ...
        title: t("success"),
        message: t("onboarding.role.toast.success"),
      });
    } catch {
      setToast({
        type: TOAST_TYPE.ERROR,
        title: t("error"),
        message: t("onboarding.role.toast.error"),
      });
    }
  };
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-3">
        ...
        <Controller
          ...
          name="role"
          rules={{
            required: t("onboarding.role.required"),
          }}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-body-sm-semibold">{t(role.i18nKey)}</span>
                    </div>
                    {isSelected && (
                      <>
                        <button

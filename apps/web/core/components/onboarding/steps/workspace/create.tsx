    ...
    return (
      <div className="flex flex-col gap-10">
        <span className="text-center text-14 text-tertiary">
          {t("legacy_ui.you_don_t_seem_to_have_any_invites_to_a_workspace_and_your_instance_admin_has_re")}
        </span>
      </div>
    );
  }
  return (
    ...
    >
      <CommonOnboardingHeader
        ...
        description={t("legacy_ui.all_your_work_unified")}
      />
            ...
            render={({ field: { value, ref, onChange } }) => (
              <div className="relative flex items-center rounded-md">
                <input
                  ...
                  placeholder={t("legacy_ui.enter_workspace_name")}
                  ref={ref}
                  className={cn(
      ...
      <div className="flex flex-col gap-4">
        ...
        {hasInvitations && (
          <Button variant="ghost" size="xl" className="w-full" onClick={handleCurrentViewChange}>
            {t("legacy_ui.join_existing_workspace")}
          </Button>
        )}
      </div>
    </form>

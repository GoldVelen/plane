        ...
        <div className="flex h-full w-full flex-col items-center px-8 pt-6 pb-10">
          ...
          <div className="flex h-full w-full flex-col items-center justify-center gap-7">
            <div className="flex flex-col items-center gap-11">
              <img src={GradientLogo} className="h-24 w-40 object-contain" alt="" />
              <div className="flex max-w-124 flex-col items-center gap-3">
                <h1 className="text-h2-semibold text-primary">{t("legacy_ui.welcome_to_plane")}</h1>
                <p className="text-center text-body-md-regular text-secondary">
                  {t("legacy_ui.set_up_your_instance_and_create_your_first_workspace_to_begin_managing_projects_")}
                </p>
              </div>
            </div>
